...
const (
	...
	// I/O ports.
	//
	// Here, _RFLAGS_IOPL is used only to determine whether the task is
	...
	// kernel mode.
	//
	// _RFLAGS_IOPL is not set in host and kernel modes and we always set
	...
	// mode.
	UserFlagsSet = _RFLAGS_RESERVED | _RFLAGS_IF | _RFLAGS_IOPL

	// KernelFlagsClear should always be clear in the kernel.
	KernelFlagsClear = _RFLAGS_STEP | _RFLAGS_IF | _RFLAGS_IOPL | _RFLAGS_AC | _RFLAGS_NT | _RFLAGS_IOPL
