...
const (
	...
	performanceIdentifiers               = extendedStart + 0x1a // Performance Optimization Identifiers.
	cacheProperties                      = extendedStart + 0x1d // Cache Properties.
	computeUnitIdentifiers               = extendedStart + 0x1e // Compute Unit Identifiers.
)
...
var allowedExtendedFunctions = [...]bool{
	...
	cacheProperties - extendedStart:        true,
	performanceIdentifiers - extendedStart: true,
	computeUnitIdentifiers - extendedStart: true,
}
...
func (i *In) normalize() {
	...
	case processorBrandString2, processorBrandString3, processorBrandString4, l1CacheAndTLBInfo, l2CacheInfo:
		i.Ecx = 0 // Ignore.
	case performanceIdentifiers, computeUnitIdentifiers, addressSizes:
		i.Ecx = 0 // Ignore.
